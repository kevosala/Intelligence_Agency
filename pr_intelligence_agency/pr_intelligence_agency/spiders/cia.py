...
class SpiderCIA(scrapy.Spider):
    ...
    def parse(self, response):
        links_declassifield = response.xpath('//a[starts-with(@href, "collection") and (parent::h3|parent::h2)]/@href').getall()
    ...
    def parse_link(self, response, **kwargs):
        ...
        praragraph = response.xpath('//div[@class="field-item even"]//p[not(@class)]/text()').get()
